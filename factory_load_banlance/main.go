...
import (
	...
	"net/http/httputil"
	"net/url"
	"proxy_demo/factory_load_banlance/load_banlance"
	"strconv"
	"strings"
	"time"
)
...
func main(){
	rb := load_banlance.LoadBanlanceFactory(load_banlance.LbWeightRoundRobin)
...
func NewMultipleHostsReverseProxy(lb load_banlance.LoadBanlance) *httputil.ReverseProxy {
	//请求协调者
